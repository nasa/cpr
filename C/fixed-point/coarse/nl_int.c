...
/*@ 
 axiomatic nl {
   logic integer nl_awb_nn(integer awb) =
     ( awb <= 124917589 ? 59: // 07721755
  ...
  logic integer nl_awb(integer awb)
  = ( awb<pow231 ? nl_awb_nn(awb) : nl_awb_nn(inv_u32(awb)) );

} */

/*@
  requires 0 <= awb <= pow231; 
  ensures \result == nl_awb_nn(awb);
 */
int_type nl_awb_nn(int_type awb) {
...
/*@
  requires 0 <= awb <= pow232; 
  ensures \result == nl_awb(awb);
 */
int_type nl_awb(int_type awb) {
  return ( awb<pow231 ? nl_awb_nn(awb) : nl_awb_nn(-awb) );
}